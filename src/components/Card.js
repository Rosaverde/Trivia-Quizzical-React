...
export default function Card(props)
{
    return(
        <main className="main-container">
            ...
            <svg className="yellow-blop" width="158" height="141" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="welcome-title">Test</h1>

            <svg className="blue-blop" width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
